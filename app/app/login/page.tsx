    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#E6F0FF] p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl shadow-blue-500/5 ring-1 ring-gray-100 p-8">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-center">
          ...
          <div className="text-xs text-gray-600 space-y-1 bg-gray-50 py-3 px-4 rounded-lg inline-block text-left">
            <p>
              <span className="font-bold text-gray-800">Admin:</span> admin /
              admin123
            </p>
            <p>
              <span className="font-bold text-gray-800">Staff:</span> staff /
              staff123
            </p>
          </div>
        </div>
